...
function TreeMenuItem(text, url, icon) {
...
function treeMenuDisplay() {
  ...
  treeMenuDocument.write('<img src="../skins/' + getCookie('skin') + '/nav/mailbox_16x16.gif" align=left border=0 vspace=0 hspace=0>');
...
function treeMenuDisplayItem(item) {
  ...
  if (item.url != "")
    treeMenuDocument.write("<a href='#' onClick='" + item.url + ";" + cmd + "'>");    
  else
