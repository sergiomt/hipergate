	    ...
	    <TD ROWSPAN="2" CLASS="subtitle" ALIGN="right"><IMG SRC="../skins/{$param_skin}/tab/angle45_24x24.gif" style="display:block" WIDTH="24" HEIGHT="24" BORDER="0"/></TD>
          ...
          <TR>
	          ...
	          <xsl:if test="$param_windowstate='NORMAL'">
      	            <A HREF="windowstate.jsp?gu_user={$param_user}&amp;nm_page=desktop.jsp&amp;nm_portlet=com.knowgate.http.portlets.RecentPostsTab&amp;gu_workarea={$param_workarea}&amp;nm_zone={$param_zone}&amp;id_state=MINIMIZED"><IMG SRC="../skins/{$param_skin}/tab/minimize12.gif" WIDTH="16" HEIGHT="16" BORDER="0" HSPACE="4" VSPACE="2"/></A>
	          </xsl:if>
	          <xsl:if test="$param_windowstate='MINIMIZED'">
      	            <A HREF="windowstate.jsp?gu_user={$param_user}&amp;nm_page=desktop.jsp&amp;nm_portlet=com.knowgate.http.portlets.RecentPostsTab&amp;gu_workarea={$param_workarea}&amp;nm_zone={$param_zone}&amp;id_state=NORMAL"><IMG SRC="../skins/{$param_skin}/tab/maximize12.gif" WIDTH="16" HEIGHT="16" BORDER="0" HSPACE="4" VSPACE="2"/></A>
	          </xsl:if>
	          </TD>
	          <TD BACKGROUND="../skins/{$param_skin}/tab/tabbackflat.gif" CLASS="subtitle">Forums</TD>	          
	        </TR></TABLE>
      	    </TD>
          </TR>
        </TABLE>
	...
	<xsl:if test="$param_windowstate='NORMAL'">
	  ...
	  <TR>
	    <TD COLSPAN="2">
	      ...
	      <TR><TD COLSPAN="3"><A CLASS="linkplain" HREF="#" onclick="readMessage('{gu_category}','{gu_msg}')" TITLE="{nm_author}"><xsl:value-of select="tx_subject"/></A>&#160;<FONT CLASS="textsmall"><xsl:value-of select="dt_published"/></FONT></TD></TR>
	      </xsl:for-each>
	      </TABLE>
            </TD>
          </TR>
