      ...
      <TD BACKGROUND="../images/images/graylinebottom.gif">
        <TABLE CELLSPACING="0" CELLPADDING="0" BORDER="0">
          ...
          <TR>
	          ...
	          <TD BACKGROUND="../skins/{$param_skin}/tab/tabbackflat.gif" CLASS="subtitle"><xsl:value-of select="exception/nm_class"/></TD>	          
	        </TR></TABLE>
      	    </TD>
          </TR>
        </TABLE>
    ...
    <TR>
      ...
      <TD CLASS="menu1">
        <TABLE CELLSPACING="8" BORDER="0">
          <TR>
            <TD ALIGN="middle">
              <IMG SRC="../images/images/yield.gif" width="32" height="32" BORDER="0" ALT=""/>
            </TD>
            <TD ALIGN="left" VALIGN="middle" CLASS="textplain">
              <xsl:value-of select="exception/tx_message"/>
	          </TD>
	        </TR>
	      </TABLE>
      </TD>
