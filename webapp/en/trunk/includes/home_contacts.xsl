  ...
  <TABLE CELLSPACING="0" CELLPADDING="0" BORDER="0">
	    ...
	    <TD ROWSPAN="2" CLASS="subtitle" ALIGN="right"><IMG SRC="../skins/{$param_skin}/tab/angle45_24x24.gif" style="display:block" WIDTH="24" HEIGHT="24" BORDER="0"/></TD>
          ...
          <TR>
	          ...
	          <xsl:if test="$param_windowstate='NORMAL'">
      	            <A HREF="windowstate.jsp?gu_user={$param_user}&amp;nm_page=desktop.jsp&amp;nm_portlet=com.knowgate.http.portlets.RecentContactsTab&amp;gu_workarea={$param_workarea}&amp;nm_zone={$param_zone}&amp;id_state=MINIMIZED"><IMG SRC="../skins/{$param_skin}/tab/minimize12.gif" WIDTH="16" HEIGHT="16" BORDER="0" HSPACE="4" VSPACE="2"/></A>
	          </xsl:if>
	          <xsl:if test="$param_windowstate='MINIMIZED'">
      	            <A HREF="windowstate.jsp?gu_user={$param_user}&amp;nm_page=desktop.jsp&amp;nm_portlet=com.knowgate.http.portlets.RecentContactsTab&amp;gu_workarea={$param_workarea}&amp;nm_zone={$param_zone}&amp;id_state=NORMAL"><IMG SRC="../skins/{$param_skin}/tab/maximize12.gif" WIDTH="16" HEIGHT="16" BORDER="0" HSPACE="4" VSPACE="2"/></A>
	          </xsl:if>
	          </TD>
	          <TD BACKGROUND="../skins/{$param_skin}/tab/tabbackflat.gif" CLASS="subtitle">Recent Contacts</TD>	          
	        </TR></TABLE>
      	    </TD>
          </TR>
        </TABLE>
	...
	<xsl:if test="$param_windowstate='NORMAL'">
        <TABLE CELLSPACING="8" BORDER="0">
          <TR>
            <TD ALIGN="middle">
              <IMG SRC="../images/images/crm/contacts.gif" BORDER="0" ALT=""/>
            </TD>
            <TD ALIGN="left" VALIGN="middle">
              <TABLE>
                <TR>
                  <TD VALIGN="middle"><A HREF="#" onclick="createContact()" CLASS="linkplain">New Contact</A></TD>
                </TR>
                <TR>
                  <TD VALIGN="middle"><INPUT TYPE="text" NAME="full_name" MAXLENGTH="50" SIZE="15" CLASS="combomini"/>&#160;<A HREF="#" onclick="searchContact();return false;" CLASS="linkplain">Search</A></TD>                
                </TR>
              </TABLE>
	    </TD>
	  </TR>
	  <TR>
		...
		<xsl:if test="gu_company=''">
		<TR>
		  <TD><A CLASS="linksmall" HREF="#" onclick="modifyContact('{gu_contact}')"><xsl:value-of select="full_name"/></A></TD>
		  <TD><FONT CLASS="textsmall"><xsl:value-of select="work_phone"/></FONT></TD>
		  <TD><xsl:if test="tx_email!=''"><A CLASS="linksmall" HREF="mailto:{tx_email}"><xsl:value-of select="tx_email"/></A></xsl:if></TD>
		</TR>
		<xsl:if test="nm_company!=''">
		<TR><TD COLSPAN="3"><FONT CLASS="textsmall"><I>(<xsl:value-of select="nm_company"/>)</I></FONT></TD></TR>
		</xsl:if>		
		</xsl:if>
		
		<xsl:if test="gu_company!=''">
		<TR>
		  <TD><A CLASS="linksmall" HREF="#" onclick="modifyCompany('{gu_company}','{nm_company}')"><xsl:value-of select="nm_company"/></A></TD>
		  <TD><FONT CLASS="textsmall"><xsl:value-of select="work_phone"/></FONT></TD>
		  <TD><xsl:if test="tx_email!=''"><A CLASS="linksmall" HREF="mailto:{tx_email}"><xsl:value-of select="tx_email"/></A></xsl:if></TD>
		</TR>
		<TR><TD COLSPAN="3"><IMG SRC="../images/images/spacer.gif" BORDER="0" HEIGHT="4"/></TD></TR>
		</xsl:if>
	      </xsl:for-each>
	      </TABLE>
            </TD>
