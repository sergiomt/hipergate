...
this.imgURL = '../images/images/htmlarea/';
this.debug  = 0;
...
function editor_action(button_id) {
  ...
  // help popup
  if (cmdID == 'showhelp') {
    window.open("../common/htmlarea_popups/editor_help.html", 'EditorHelp');
    return;
  }

  // popup editor
  if (cmdID == 'popupeditor') {
    window.open("../common/htmlarea_popups/fullscreen.html?"+objname,
                'FullScreen',
  ...
  // Custom2
    ...
    var myText = showModalDialog("../common/htmlarea_popups/custom2.html",
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog("../common/htmlarea_popups/select_color.html", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog("../common/htmlarea_popups/insert_image.html", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
    }

    // insert table
    else if (cmdID.toLowerCase() == 'inserttable'){
      showModalDialog("../common/htmlarea_popups/insert_table.html?"+objname,
                                 window,
                                 "resizable: yes; help: no; status: no; scroll: no; ");
    }
...
function editor_about(objname) {
  showModalDialog("../common/htmlarea_popups/about.html", window, "resizable: yes; help: no; status: no; scroll: no; ");
}
