...
<HTML>
  ...
  <FRAMESET NAME="textload" ROWS="60,200,*">
    ...
    <FRAME NAME="bad" MARGINWIDTH="0" MARGINHEIGHT="0" SRC="textloader4e.jsp?gu_workarea=<%=gu_workarea%>&nm_file=<%=Gadgets.URLEncode(nm_file)%>&id_status=<%=id_status%>&tp_file=bad">
