...
<BODY  TOPMARGIN="8" MARGINHEIGHT="8" onLoad="setCombos()">
  ...
  <TABLE WIDTH="100%">
    ...
    <TR><TD CLASS="striptitle"><FONT CLASS="title1">[~Crear Alumno~]</FONT></TD></TR>
  </TABLE>
  ...
  <CENTER>
        ...
        <TABLE WIDTH="100%">
          <TR><TD>
            <TABLE ALIGN="center">
              ...
              <TR>
                <TD ALIGN="right" WIDTH="110"><FONT CLASS="formplain">[~Matr&iacute;cula:~]</FONT></TD>
                <TD ALIGN="left" WIDTH="370">
              ...
              <TR>
                <TD ALIGN="right" WIDTH="110"><FONT CLASS="formplain">[~Turno:~]</FONT></TD>
    ...
    <DIV onclick="selectTab(0)" id="p1tab0" class="tab" style="background-color:#eeeeee; left:0px; top:0px; z-index:4; clip:rect(0 auto 30 0); cursor:hand">[~Alumno~]</DIV>
	...
	<INPUT TYPE="hidden" NAME="id_legal" MAXLENGTH="16" VALUE="">
        ...
        <TABLE ALIGN="center">
          <TR>
            <TD ALIGN="right" WIDTH="110"><FONT CLASS="formstrong">[~Centro:~]</FONT></TD>            
            <TD ALIGN="left" WIDTH="420">
...
%>
          ...
          <TR>
            <TD ALIGN="right" WIDTH="110"><FONT CLASS="formstrong">[~Asignaturas:~]</FONT></TD>            
    	    <TD ALIGN="left">
...
%>
    ...
    <DIV onclick="selectTab(1)" id="p1tab1" class="tab" style="background-color:#dddddd; left:150px; top:0px; z-index:3; clip:rect(0 auto 30 0)"><SPAN onmouseover="this.style.cursor='hand';" onmouseout="this.style.cursor='auto';">[~Centro~]</SPAN></DIV>
