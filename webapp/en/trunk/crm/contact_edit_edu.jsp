...
<% if (gu_contact.length()>0) { %>
  <TABLE CELLSPACING="2" CELLPADDING="2">
    ...
    <TR>
      ...
      <TD VALIGN="middle"><A HREF="javascript:viewNotes()" CLASS="linkplain">[~Notas~]</A></TD>
      <TD VALIGN="middle"><IMG SRC="../images/images/attachedfile16x16.gif" WIDTH="21" HEIGHT="17" BORDER="0"></TD>
      <TD VALIGN="middle"><A HREF="javascript:viewAttachments()" CLASS="linkplain">[~Archivos Adjuntos~]</A></TD>
      <TD VALIGN="middle"><IMG SRC="../images/images/training/student16.gif" WIDTH="15" HEIGHT="18" BORDER="0"></TD>
      <TD VALIGN="middle"><A HREF="#" onclick="viewCourses()" CLASS="linkplain">[~Cursos~]</A></TD>
    ...
    <TABLE WIDTH="100%">
      <TR><TD>
        <TABLE ALIGN="center">
          ...
          <TR>
            <TD ALIGN="right" WIDTH="110"><FONT CLASS="formstrong">[~Matr&iacute;cula:~]</FONT></TD>
            <TD ALIGN="left" WIDTH="370">
          ...
          <TR>
            <TD ALIGN="right" WIDTH="110"><FONT CLASS="formplain">[~Tipo:~]</FONT></TD>
          ...
          <TR>
            <TD ALIGN="right" WIDTH="110"><FONT CLASS="formplain">[~Centro:~]</FONT></TD>            
            <TD ALIGN="left" WIDTH="420">
...
%>
          ...
          <TR>
            ...
            <TD ALIGN="left" WIDTH="420">
              ...
              <SELECT CLASS="combomini" NAME="sel_status"><OPTION VALUE=""></OPTION><%=sStatusLookUp%></SELECT>&nbsp;<A HREF="javascript:lookup(2)"><IMG SRC="../images/images/find16.gif" HEIGHT="16" BORDER="0" ALT="[~Ver Lista de Estados~]"></A>
