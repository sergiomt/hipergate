...
<BODY  TOPMARGIN="8" MARGINHEIGHT="8" onLoad="setCombos()">
  ...
  <CENTER>
            ...
            <TABLE ALIGN="center">
              ...
              <TR>
                ...
                <TD ALIGN="left" WIDTH="420">
                  <SELECT CLASS="combomini" NAME="sel_title"><OPTION VALUE=""></OPTION><%=sTitleLookUp%></SELECT>&nbsp;<A HREF="javascript:lookup(1)"><IMG SRC="../images/images/find16.gif" HEIGHT="16" BORDER="0" ALT="View list of employments"></A>
	...
	<SELECT CLASS="combomini" STYLE="visibility:hidden" NAME="sel_acourse"></SELECT>
        ...
        <TABLE ALIGN="center">
          <TR>
            ...
            <TD ALIGN="left" WIDTH="420">
                ...
                <OPTION VALUE="00000000000000000000000000000000">None</OPTION>
<%             
...
%>
          ...
          <TR>
            ...
            <TD ALIGN="left" WIDTH="370">
              ...
              &nbsp;&nbsp;<A HREF="javascript:reference(1)"><IMG SRC="../images/images/find16.gif" HEIGHT="16" BORDER="0" ALT="View list of companies"></A>
            </TD>
          </TR>
          <TR>
          ...
          <TR>
            ...
            <TD ALIGN="left" WIDTH="370">
              <INPUT TYPE="text" NAME="nm_sector" MAXLENGTH="32" SIZE="40" TABINDEX="-1" onfocus="document.forms[1].id_legal.focus()">&nbsp;<A HREF="javascript:lookup(3)"><IMG SRC="../images/images/find16.gif" HEIGHT="16" BORDER="0" ALT="View list of sectors"></A>
              <INPUT TYPE="hidden" NAME="id_sector">
            </TD>
          </TR>
          <TR>
          ...
          <TR>
            ...
            <TD ALIGN="left" WIDTH="370"><SELECT STYLE="visibility:hidden" NAME="sel_typecompany"><OPTION VALUE=""></OPTION><%=sTypeLookUp%></SELECT>&nbsp;<A HREF="javascript:lookup(4)"><IMG SRC="../images/images/find16.gif" HEIGHT="16" BORDER="0" ALT="View list of company types"></A></TD>
          </TR>          
          <TR>
            <TD ALIGN="right" WIDTH="90"><FONT CLASS="formplain">Invoicing</FONT></TD>
            <TD ALIGN="left" WIDTH="370">
              <INPUT TYPE="text" NAME="im_revenue" MAXLENGTH="11" SIZE="10">
              &nbsp;&nbsp;&nbsp;<FONT CLASS="formplain">Number of employees:</FONT>&nbsp;
              <INPUT TYPE="text" NAME="nu_employees" MAXLENGTH="9" SIZE="10">
            </TD>
          </TR>          
          <TR>
            <TD ALIGN="right" WIDTH="90"><FONT CLASS="formplain">Foundation Date</FONT></TD>
            <TD ALIGN="left" WIDTH="370">
        ...
        <TABLE>
          <TR><TD>
            <TABLE WIDTH="100%">
              ...
              <TR>
                <TD ALIGN="right" WIDTH="140"><FONT CLASS="formplain">Address Types</FONT></TD>
