...
abstract class NameServicePacket {
    ...
    private static final int LOOKUP_RESP_LIMIT = com.knowgate.jcifs.Config.getInt( "jcifs.netbios.lookupRespLimit", 5 );
    ...
    public String toString() {
        ...
        switch( resultCode ) {
            ...
            case CFT_ERR:
                ...
                break;
            default:
                resultCodeString = "0x" + Gadgets.toHexString( resultCode, 1 );
        }
        switch( questionType ) {
            case NB:
            ...
            default:
                questionTypeString = "0x" + Gadgets.toHexString( questionType, 4 );
        }
        switch( recordType ) {
            case A:
                recordTypeString = "A";
            ...
            default:
                recordTypeString = "0x" + Gadgets.toHexString( recordType, 4 );
        }
        ...
        return new String(
                ...
                ",questionClass=" + ( questionClass == IN ? "IN" :
                            "0x" + Gadgets.toHexString( questionClass, 4 )) +
                ",recordName=" + recordName +
                ",recordType=" + recordTypeString +
                ",recordClass=" + ( recordClass == IN ? "IN" :
                            "0x" + Gadgets.toHexString( recordClass, 4 )) +
                ",ttl=" + ttl +
