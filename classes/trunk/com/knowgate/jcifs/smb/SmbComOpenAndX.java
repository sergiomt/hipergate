...
class SmbComOpenAndX extends AndXServerMessageBlock {
    ...
    public String toString() {
        return new String( "SmbComOpenAndX[" +
            ...
            ",searchAttributes=0x" + Gadgets.toHexString( searchAttributes, 4 ) +
            ",fileAttributes=0x" + Gadgets.toHexString( fileAttributes, 4 ) +
            ",creationTime=" + new Date( creationTime ) +
            ",openFunction=0x" + Gadgets.toHexString( openFunction, 2 ) +
