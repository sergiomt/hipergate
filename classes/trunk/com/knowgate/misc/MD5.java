...
/*
 * $Header: /cvsroot/hipergate/backend/src/com/knowgate/misc/MD5.java,v 1.1.1.1 2005/06/23 15:15:08 smontoro Exp $
 *
...
/*      System.out.println("out[" + i + "] = \t" +
  ...
  public void Update (MD5State stat, byte buffer[], int offset, int length)
    ...
    if (DebugFile.trace) {
      DebugFile.decIdent();
      DebugFile.writeln("End MD5.Update()");
    }
  } // Update
   ...
   */
  public void Update (byte buffer[]) throws NullPointerException {
      if (null==buffer) throw new NullPointerException("Array of bytes to be hashed may not be null");
...
//     s.getBytes(0, s.length(), chars, 0);
  ...
  public synchronized byte[] Final () {
    ...
    byte[] byRetArray = Encode(finals.state, 16);

    if (DebugFile.trace) DebugFile.writeln("MD5.Final() : " + Gadgets.toHexString(byRetArray));
