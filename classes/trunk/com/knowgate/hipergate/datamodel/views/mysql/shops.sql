...
FROM k_shops s, k_orders o
LEFT OUTER JOIN k_sale_points AS p ON o.gu_sale_point=p.gu_sale_point
LEFT OUTER JOIN k_warehouses AS w ON o.gu_warehouse=w.gu_warehouse
LEFT OUTER JOIN k_addresses AS a ON o.gu_ship_addr=a.gu_address
LEFT OUTER JOIN k_addresses AS b ON o.gu_bill_addr=b.gu_address
LEFT OUTER JOIN k_companies AS c ON o.gu_company=c.gu_company
...
FROM k_shops s, k_despatch_advices d
LEFT OUTER JOIN k_addresses AS a ON d.gu_ship_addr=a.gu_address
LEFT OUTER JOIN k_addresses AS b ON d.gu_bill_addr=b.gu_address
LEFT OUTER JOIN k_companies AS c ON d.gu_company=c.gu_company
...
i.nu_cvv2,i.tx_ship_notes,i.tx_email_to,i.tx_comments,i.gu_company,c.nm_legal,
c.nm_commercial,c.id_sector,c.tp_company,c.gu_geozone,i.gu_ship_addr,
i.gu_bill_addr,b.ix_address AS bill_ix_address,b.tp_location AS bill_tp_location,
b.nm_company AS bill_nm_company,b.tp_street AS bill_tp_street,
b.nm_street AS bill_nm_street,b.nu_street AS bill_nu_street,
b.tx_addr1 AS bill_tx_addr1,b.tx_addr2 AS bill_tx_addr2,
b.id_country AS bill_id_country,b.nm_country AS bill_nm_country,
b.id_state AS bill_id_state,b.nm_state AS bill_nm_state,
b.mn_city AS bill_mn_city,b.zipcode AS bill_zipcode,
b.work_phone AS bill_work_phone,b.direct_phone AS bill_direct_phone,
b.home_phone AS bill_home_phone,b.mov_phone AS bill_mov_phone,
b.fax_phone AS bill_fax_phone,b.other_phone AS bill_other_phone,
b.po_box AS bill_po_box,b.tx_email AS bill_tx_email,b.url_addr AS bill_url_addr,
b.coord_x AS bill_coord_x,b.coord_y AS bill_coord_y,
b.contact_person AS bill_contact_person,b.tx_salutation AS bill_tx_salutation,
b.id_ref AS bill_id_ref
FROM k_shops s, k_invoices i
LEFT OUTER JOIN k_x_orders_invoices AS o ON i.gu_invoice=o.gu_invoice
LEFT OUTER JOIN k_addresses AS b ON i.gu_bill_addr=b.gu_address
LEFT OUTER JOIN k_companies AS c ON i.gu_company=c.gu_company
