...
public class CurrencyConvertorLocator extends org.apache.axis.client.Service implements com.knowgate.math.webservices.CurrencyConvertor {
    ...
    public com.knowgate.math.webservices.CurrencyConvertorSoap_PortType getCurrencyConvertorSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.knowgate.math.webservices.CurrencyConvertorSoap_PortType getCurrencyConvertorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.knowgate.math.webservices.CurrencyConvertorSoap_BindingStub _stub = new com.knowgate.math.webservices.CurrencyConvertorSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.knowgate.math.webservices.CurrencyConvertorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.knowgate.math.webservices.CurrencyConvertorSoap_BindingStub _stub = new com.knowgate.math.webservices.CurrencyConvertorSoap_BindingStub(new java.net.URL(CurrencyConvertorSoap_address), this);
                _stub.setPortName(getCurrencyConvertorSoapWSDDServiceName());
                return _stub;
            }
        }
